...
```markdown
![示例图片](/assets/images/posts/sample-image.png)
```
...
```markdown
![示例图片](../images/posts/sample-image.png)
```
...
```html
<img src="/assets/images/posts/sample-image.png" alt="示例图片" width="300" height="200">
```
...
```markdown
[![示例图片](/assets/images/posts/sample-image.png)](/about)
```
...
<div style="text-align: center;">
  <img src="/assets/images/posts/sample-image.png" alt="居中图片" style="width: 200px;">
</div>

<div style="float: right; margin-left: 20px;">
  <img src="/assets/images/posts/sample-image.png" alt="右对齐图片" style="width: 150px;">
</div>
